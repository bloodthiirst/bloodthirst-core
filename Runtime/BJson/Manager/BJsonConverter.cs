...
namespace Bloodthirst.BJson
{
    public static class BJsonConverter
    {
        ...
        public static string ToJson<T>(T instance)
        {
            ...
            return c.Serialize(instance , new BJsonContext() , new BJsonSettings());
        }
        ...
        public static T FromJson<T>(string json)
        {
            ...
            return (T) c.Deserialize(json , new BJsonContext() , new BJsonSettings());
        }
        ...
        public static void PopulateFromJson<T>(T instance , string json) where T : class
        {
            Type t = typeof(T);
            IBJsonConverterInternal c = Json.GetConverter(t);
            c.Populate(instance, json , new BJsonContext() , new BJsonSettings());
        }
